...
RSpec.describe 'index.html' do
  it 'contains an <a> tag with the href attribute set to an absolute path' do
  ...
  it 'contains an <a> tag with the href attribute set to a relative path' do
  ...
  it 'contains an <a> tag that uses the target attribute' do
